...
With this software student only need to submit their presentation in PDF format, the PPS will do the rest like presenting documentation and report in PDF or Video format, downloading code from github and present them by compiling it automatically. If any libraries are required PPS will download them also.
